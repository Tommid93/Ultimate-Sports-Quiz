...
/* Function to set a high score and update it depending on users score*/
    let high_score = 0;
    let previousHigh = 0;
    document.querySelector(".high-score").textContent = previousHigh;
    function trySetHighestScore() {
        console.log(previousHigh)
        console.log(userScore)
        previousHighString = localStorage.getItem("high-score")
        previousHigh = previousHighString ? parseInt(previousHighString) : 0;
      
        if (userScore > previousHigh) {
